...
## Antigravity Advisory Skills (Auto-Trigger)

The following Antigravity advisory skills should be used automatically without explicit user invocation when the triggering conditions are met.
...
- Set `--project-root` to the specific project subdirectory being reviewed to prevent Antigravity from browsing sibling directories and misattributing code.
...
The following Codex advisory skills can be used automatically without explicit user invocation when the triggering conditions are met. They mirror the Antigravity skills but use the Codex CLI.

### codex-review

**Trigger:** Same as agy-review. Can be used as an alternative or complement to agy-review.
...
**Trigger:** Same as agy-error-analysis. Can be used as an alternative or complement.

- Uses `codex exec` in read-only sandbox mode.

### codex-design-checkpoint

**Trigger:** Same as agy-design-checkpoint. Can be used as an alternative or complement.
...
- Default Antigravity model is `Gemini 3.5 Flash (High)` with 20-minute wrapper timeout.
