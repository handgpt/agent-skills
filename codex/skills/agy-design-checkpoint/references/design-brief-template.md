...
Use this template when preparing an Antigravity design checkpoint.
...
Keep the brief compact. Prefer summaries plus absolute local paths over whole-file pastes. If you already know the official docs or community references that matter, include them here so Antigravity can weigh them against the local design context and look for disconfirming evidence instead of only confirming the preferred direction.
