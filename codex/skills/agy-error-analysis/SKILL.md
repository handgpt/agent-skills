...
Gemini CLI advisory skills have been removed from the Codex runtime because Gemini CLI is no longer supported. Migrate any old `$gemini-error-analysis` workflow to `$agy-error-analysis`.
