...
Use this template when preparing an Antigravity error-analysis pass.
...
Keep the brief compact. Antigravity should see the real failure signature and the few most relevant files, not a full raw dump of the workspace.
