...
- `scripts/run_gemini_error_analysis.py` wraps Gemini CLI with the shared advisory runner, explicit UUID-backed interactive sessions, and session-file result recovery.
