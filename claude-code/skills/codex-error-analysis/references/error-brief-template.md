...
Use this template when preparing a Codex error-analysis pass.
...
Keep the brief compact. Codex should see the real failure signature and the few most relevant files, not a full raw dump.
