...
echo "  CLAUDE_AGY_MODEL                Override Antigravity model (default: Gemini 3.5 Flash (High))"
echo "  CLAUDE_AGY_PRINT_TIMEOUT        Override Antigravity print timeout passed to CLI (default: 1200s)"
echo "  CLAUDE_AGY_DANGEROUSLY_SKIP_PERMISSIONS"
echo "                                   Auto-approve Antigravity tool permissions when supported (default: true)"
